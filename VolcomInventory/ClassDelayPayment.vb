Public Class ClassDelayPayment
    Public Function queryMain(ByVal condition As String, ByVal order_type As String) As String
        ...
        Dim query As String = "SELECT dp.id_propose_delay_payment, dp.id_comp_group, cg.description AS `group`, dp.number, 
        dp.created_date, dp.created_by, ec.employee_name AS `created_by_name`,
        dp.updated_date, dp.updated_by, eu.employee_name AS `updated_by_name`, 
        dp.due_date, dp.note, dp.id_report_status, rs.report_status, dp.is_submit 
        FROM tb_propose_delay_payment dp
        ...
        INNER JOIN tb_m_user uu ON uu.id_user = dp.updated_by
        ...
        WHERE dp.id_propose_delay_payment>0 "
        query += condition + " "
        query += "ORDER BY dp.id_propose_delay_payment " + order_type
        Return query
    End Function
End Class
