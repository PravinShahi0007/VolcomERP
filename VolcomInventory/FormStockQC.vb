Public Class FormStockQC
    ...
    Sub viewSOH()
        ...
        IFNULL((prec.prod_order_rec_det_qty + (COALESCE(rin.tot_ret_in, 0)-COALESCE(rout.tot_ret_out, 0) )) - COALESCE(pl.tot_pl, 0) +  COALESCE(adj_in.tot_adj_in,0) -  COALESCE(adj_out.tot_adj_out,0) - COALESCE(ass.tot_ass,0) - COALESCE(sni_out.qty,0),0) AS qty,
		...
		)sni_out ON sni_out.id_prod_order_det=pod.`id_prod_order_det`
