Public Class FormCompanyEmailMapping
    ...
    Sub form_load()
        Dim query_store As String = "
            SELECT mm.id_mail_manage_mapping, mcg.comp_group, mcc.contact_person, mcc.position, mcc.email, rmt.report_mark_type_name, mmt.mail_member_type
        ...
        Dim query_int As String = "
            SELECT mm.id_mail_manage_mapping_intern, CONCAT(memp.employee_code, ' | ', memp.employee_name) AS employee_name, memp.employee_position, memp.email_external, rmt.report_mark_type_name, mmt.mail_member_type
