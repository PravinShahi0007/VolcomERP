    ...
    Private Sub BUnable_Click(sender As Object, e As EventArgs) Handles BUnable.Click
        ...
        Else
            For i As Integer = 0 To FormPurcOrder.GVPurcReq.RowCount - 1
                ...
                Else
                    Dim query_upd As String = "UPDATE tb_purc_req_det SET is_unable_fulfill=1 WHERE id_purc_req_det='" & FormPurcOrder.GVPurcReq.GetRowCellValue(i, "id_purc_req_det").ToString & "'"
