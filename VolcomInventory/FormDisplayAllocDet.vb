Public Class FormDisplayAllocDet
    ...
    Dim capacity_old As String = "0"
    Dim qty_size_old As String = "0"
    ...
    Private Sub BtnConfirm_Click(sender As Object, e As EventArgs) Handles BtnConfirm.Click
        If SLEDisplayType.EditValue = Nothing Then
        ...
        Else
            ...
            Dim log_note As String = "Capacity:" + capacity_old + " to " + capacity + "; Size per SKU:" + qty_size_old + " to " + qty_size + ";"
            ...
            INSERT INTO tb_display_alloc_log VALUES('" + id_class_group + "','" + id_display_type + "', '" + id_user + "', NOW(), '" + log_note + "'); "
    ...
    Private Sub SLEDisplayType_EditValueChanged(sender As Object, e As EventArgs) Handles SLEDisplayType.EditValueChanged
        ...
        If dt.Rows.Count > 0 Then
            ...
            capacity_old = decimalSQL(dt.Rows(0)("capacity").ToString)
            qty_size_old = decimalSQL(dt.Rows(0)("qty_size").ToString)
        Else
            id_display_alloc = "-1"
            TxtQty.EditValue = 0
            TxtCapacity.EditValue = 0.00
