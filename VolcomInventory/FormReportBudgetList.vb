...
INNER JOIN tb_b_expense_opex o ON ot.`id_b_expense_opex`=o.`id_b_expense_opex` AND o.id_item_cat_main='" & id_cat_main & "'
...
INNER JOIN tb_b_expense e ON e.`id_b_expense`=et.`id_b_expense` AND e.id_item_cat_main='" & id_cat_main & "'
