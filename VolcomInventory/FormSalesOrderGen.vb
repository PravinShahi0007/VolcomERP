Public Class FormSalesOrderGen
                         ...
                         Select New With
                                {
                                    ...
                                    .class = If(resultstc Is Nothing, "", resultstc("class").ToString),
                                    .color = If(resultstc Is Nothing, "", resultstc("color").ToString),
                                    .sht = If(resultstc Is Nothing, "", resultstc("sht").ToString),
    ...
    Private Sub BtnSave_Click(sender As Object, e As EventArgs) Handles BtnSave.Click
        ...
        ElseIf Not is_multiple = "-1" Then
            stopCustom("Reference number already used !")
        Else
            If action = "ins" Then
                Cursor = Cursors.WaitCursor
                'query main
