Public Class FormBankWithdrawalSumDate
    ...
    Private Sub BPick_Click(sender As Object, e As EventArgs) Handles BPick.Click
        ...
        Else
            'update
            Dim id_current As String = "current"
            Dim id_before As String = "before"
            For i = 0 To FormBankWithdrawalSum.GVList.RowCount - 1
                id_current = FormBankWithdrawalSum.GVList.GetRowCellValue(i, "id_pn").ToString()

                If id_current = id_before Then
                    'sudah
                Else
                    id_before = FormBankWithdrawalSum.GVList.GetRowCellValue(i, "id_pn").ToString()
                    '
                    Dim q As String = ""
                    Try
