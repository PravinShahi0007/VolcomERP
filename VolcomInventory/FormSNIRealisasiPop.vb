Public Class FormSNIRealisasiPop
    Private Sub FormSNIRealisasiPop_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim q As String = "SELECT d.id_item_del,dd.id_item_del_det,d.number AS item_del_number,r.`number` AS item_req_number,dd.`qty`,d.`note`,IF(r.is_for_store=1,166,156) AS report_mark_type
