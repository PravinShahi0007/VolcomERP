Public Class ReportPOSClosingNoStock
    ...
    Private Sub ReportPOSClosingNoStock_BeforePrint(sender As Object, e As Printing.PrintEventArgs) Handles MyBase.BeforePrint
        ...
        DataSource = dpd
        RepoLinkInvoice.Appearance.ForeColor = Color.Black
    End Sub
    ...
    Private Sub GVDetail_CalcRowHeight(sender As Object, e As DevExpress.XtraGrid.Views.Grid.RowHeightEventArgs) Handles GVDetail.CalcRowHeight
