Public Class FormDesignColumn
    ...
    Sub view_category()
        viewSearchLookupQuery(SLUECategory, "SELECT id_design_column_category, category FROM tb_design_column_category", "id_design_column_category", "category", "id_design_column_category")
    End Sub
    ...
    Sub view_type()
        ...
        Dim view_all As String = execute_query("SELECT view_all FROM tb_design_column_category WHERE id_design_column_category = " + id_design_column_category, 0, True, "", "", "", "")
    ...
    Sub form_load()
        ...
        Dim data_column As DataTable = execute_query("
            ...
            WHERE id_design_column_category = " + id_design_column_category + "
        ", -1, True, "", "", "", "")
        ...
        Dim data_row As DataTable = execute_query("
            ...
            WHERE tb_design_column.id_design_column_category = " + id_design_column_category + " AND tb_design_column_value.column_type_front " + If(column_type_front = "", "IS NULL", "= " + column_type_front) + " AND tb_design_column_value.column_type_end " + If(column_type_end = "", "IS NULL", "= " + column_type_end) + "
        ", -1, True, "", "", "", "")
    ...
    Private Sub BarButtonItemAddValue_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles BarButtonItemAddValue.ItemClick
        ...
        Try
            FormDesignColumnValue.id_design_column_category = id_design_column_category
    ...
    Private Sub BarButtonItemAddColumn_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles BarButtonItemAddColumn.ItemClick
        Try
            FormDesignColumnDet.id_design_column_category = id_design_column_category
