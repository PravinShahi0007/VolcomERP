...
Public Class FormSalesDelOrderSlip
    ...
    Sub viewSalesDelOrder()
        ...
        Dim query As String = del.queryMainLess("AND a.id_report_status=1 AND a.is_combine=2 AND a.id_comp_contact_from='" + id_comp_contact_from + "' AND a.id_store_contact_to='" + id_store_contact_to + "' AND a.last_update_by=" + id_user + " AND cat.is_combine_del=1 ", "2")
        Dim data As DataTable = execute_query(query, -1, True, "", "", "", "")
