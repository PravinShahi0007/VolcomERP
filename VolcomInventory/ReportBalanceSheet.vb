Public Class ReportBalanceSheet
    Private Sub ReportBalanceSheet_BeforePrint(sender As Object, e As Printing.PrintEventArgs) Handles MyBase.BeforePrint
        ...
        For i = 0 To FormReportBalanceSheet.GVAktiva.RowCount - 1 - GetGroupRowCount(FormReportBalanceSheet.GVAktiva)
            ...
            If Not pembanding = Strings.Left(FormReportBalanceSheet.GVAktiva.GetRowCellValue(i, "acc_name").ToString, 1) And Not pembanding = "0" Then
                add_row(FormReportBalanceSheet.GVAktiva.GetRowCellValue(i - 1, "head_name").ToString, "Total " & FormReportBalanceSheet.GVAktiva.GetRowCellValue(i - 1, "head_desc").ToString, 5, True, "", "")
            End If
            ...
            If Not pembanding_sub = Strings.Left(FormReportBalanceSheet.GVAktiva.GetRowCellValue(i, "acc_name").ToString, 2) And Not pembanding_sub = "0" Then
                add_row(FormReportBalanceSheet.GVAktiva.GetRowCellValue(i - 1, "sub_name").ToString, "Total " & FormReportBalanceSheet.GVAktiva.GetRowCellValue(i - 1, "sub_desc").ToString, 7, True, Decimal.Parse(sub_prev_month_value.ToString).ToString("N2"), Decimal.Parse(sub_this_month_value.ToString).ToString("N2"))
            ...
            If Not pembanding = Strings.Left(FormReportBalanceSheet.GVAktiva.GetRowCellValue(i, "acc_name").ToString, 1) Then
                add_row(FormReportBalanceSheet.GVAktiva.GetRowCellValue(i, "head_name").ToString, FormReportBalanceSheet.GVAktiva.GetRowCellValue(i, "head_desc").ToString, 5, False, "", "")
            End If

            'sub header
            If Not pembanding_sub = Strings.Left(FormReportBalanceSheet.GVAktiva.GetRowCellValue(i, "acc_name").ToString, 2) Then
                add_row(FormReportBalanceSheet.GVAktiva.GetRowCellValue(i, "sub_name").ToString, FormReportBalanceSheet.GVAktiva.GetRowCellValue(i, "sub_desc").ToString, 7, False, "", "")
            End If
            ...
            If i = FormReportBalanceSheet.GVAktiva.RowCount - 1 - GetGroupRowCount(FormReportBalanceSheet.GVAktiva) Then
                add_row(FormReportBalanceSheet.GVAktiva.GetRowCellValue(i, "sub_name").ToString, "Total " & FormReportBalanceSheet.GVAktiva.GetRowCellValue(i, "sub_desc").ToString, 7, True, Decimal.Parse(sub_prev_month_value.ToString).ToString("N2"), Decimal.Parse(sub_this_month_value.ToString).ToString("N2"))
            End If
        Next
    ...
    Sub add_row(ByVal acc_name As String, ByVal acc_desc As String, ByVal pad As Integer, ByVal border_all As Boolean, ByVal prev_month_value As String, ByVal this_month_value As String)
        Dim font_row_style As New Font("Segoe UI", 7, FontStyle.Regular)
        ...
        XTableAktiva.Rows.Add(row_header)
    End Sub
End Class