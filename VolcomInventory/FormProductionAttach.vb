...
LEFT JOIN tb_prod_order_attach att ON att.id_prod_order=po.id_prod_order AND att.id_report_status!=5
WHERE po.`id_report_status`='6' AND ISNULL(att.id_prod_order_attach)
