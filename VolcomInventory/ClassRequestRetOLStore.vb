Public Class ClassRequestRetOLStore
    Public Function queryMain(ByVal condition As String, ByVal order_type As String) As String
        ...
        r.awb_number, r.note, r.id_report_status, stt.report_status, (SELECT COUNT(*) FROM tb_ol_store_ret_req_det WHERE id_ol_store_ret_req = r.id_ol_store_ret_req) AS qty_fisik
