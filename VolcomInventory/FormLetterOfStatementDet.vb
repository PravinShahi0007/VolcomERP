Public Class FormLetterOfStatementDet
    ...
    Private Sub SBSavePrint_Click(sender As Object, e As EventArgs) Handles SBSavePrint.Click
        Dim query As String = "INSERT INTO tb_letter_of_statement (id_popup, number, date, id_employee, created_date, created_by) VALUES (" + SLUEType.EditValue.ToString + ", '" + TENumberFront.EditValue.ToString + TENumberBack.EditValue.ToString + "', '" + Date.Parse(DEDate.EditValue.ToString).ToString("") + "', " + SLUEEmployee.EditValue.ToString + ", NOW(), " + id_user + "); SELECT LAST_INSERT_ID();"
