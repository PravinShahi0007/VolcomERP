Public Class ClassPromoZalora
    Public Function queryMain(ByVal condition As String, ByVal order_type As String) As String
        ...
        Dim query As String = "SELECT p.id_promo_zalora, p.`number`, p.discount_code, p.discount_value, p.volcom_pros, 
        p.propose_created_date, p.propose_created_by, ep.employee_name AS `propose_created_by_name`, 
        p.id_report_status, stt.report_status, p.rmt_propose
