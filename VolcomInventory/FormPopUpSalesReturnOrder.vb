        ...
        ElseIf id_pop_up = "2" Then
            ...
            If id_sales_return_order_det = "-1" Then 'new
                ...
                Else
                    ...
                    FormSalesReturnDet.codeAvailableIns(GVItemList.GetFocusedRowCellValue("id_product").ToString, GVItemList.GetFocusedRowCellValue("id_product").ToString, FormSalesReturnDet.id_store, GVItemList.GetFocusedRowCellValue("id_design_price").ToString, GVItemList.GetFocusedRowCellValue("id_product").ToString)
