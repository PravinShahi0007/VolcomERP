Public Class FormSalesPOSNoStock
    ...
    Sub viewDetail()
        ...
        nsd.qty, nsd.id_design_price, nsd.design_price, nsd.note, nsd.is_verified, nsd.verified_by, vemp.employee_name AS `verified_by_name`, nsd.verified_date, IF(nsd.is_verified = 2, 0, nsd.verified_qty) AS verified_qty, nsd.verified_note, 'No' AS `is_select`
