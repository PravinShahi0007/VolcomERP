...
Partial Class FormProductionRecDet
    ...
    Private Sub InitializeComponent()
        ...
        Me.GridColumnEANCode.Width = 120
        '
        'ColName
        '
        ...
        Me.GridColumnRemainingQty.Caption = "Remaining After"
