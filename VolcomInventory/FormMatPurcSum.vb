...
WHERE dep.id_departement=4", 0, True, "", "", "", "")
            ...
            'insert po
            Dim query_kod As String = "INSERT INTO tb_prod_order_ko_det(`id_prod_order_ko`,`revision`,`id_purc_order`,`lead_time_prod`,`lead_time_prod_before`,`lead_time_payment`) VALUES"
            For i As Integer = 0 To GVProd.RowCount - 1
                If Not i = 0 Then
                    query_kod += ","
                End If
