    ...
    Sub print()
        ...
        If LEPrinter.EditValue.ToString = "1" Then 'sato
            For j As Integer = 0 To FormFGCodeReplaceStoreDet.GVBarcode.RowCount - 1
                ...
                print_command += "<ESC>H580<ESC>V00" & (add_sato_vpx + 10).ToString & "<ESC>L0200<ESC>S" & FormFGCodeReplaceStoreDet.GVBarcode.GetRowCellValue(j, "code").ToString & vbNewLine
                print_command += "<ESC>H610<ESC>V00" & (add_sato_vpx + 30).ToString & "<ESC>D202160" & FormFGCodeReplaceStoreDet.GVBarcode.GetRowCellValue(j, "code").ToString & vbNewLine
                print_command += "<ESC>H580<ESC>V0" & (add_sato_vpx + 200).ToString & "<ESC>L0200<ESC>S" & FormFGCodeReplaceStoreDet.GVBarcode.GetRowCellValue(j, "name").ToString & vbNewLine
                ...
                print_command += "<ESC>H580<ESC>V0" & (add_sato_vpx + 240).ToString & "<ESC>L0202<ESC>S" & FormFGCodeReplaceStoreDet.GVBarcode.GetRowCellValue(j, "ret_code").ToString & vbNewLine
                print_command += "<ESC>H650<ESC>V0" & (add_sato_vpx + 240).ToString & "<ESC>L0202<ESC>S" & FormFGCodeReplaceStoreDet.GVBarcode.GetRowCellValue(j, "size").ToString & vbNewLine
                print_command += "<ESC>H645<ESC>V0" & (add_sato_vpx + 235).ToString & "<ESC>(65,40" & vbNewLine
                print_command += "<ESC>H740<ESC>V0" & (add_sato_vpx + 240).ToString & "<ESC>L0202<ESC>S" & FormFGCodeReplaceStoreDet.GVBarcode.GetRowCellValue(j, "color").ToString & vbNewLine
                print_command += "<ESC>H580<ESC>V0" & (add_sato_vpx + 280).ToString & "<ESC>L0202<ESC>S" & FormFGCodeReplaceStoreDet.GVBarcode.GetRowCellValue(j, "currency").ToString & " " & Decimal.Parse(FormFGCodeReplaceStoreDet.GVBarcode.GetRowCellValue(j, "price").ToString).ToString("N0") & vbNewLine
                ...
                print_command += "<ESC>#E5"
                print_command += "<ESC>H580<ESC>V00" & (add_sato_vpx + 10).ToString & "<ESC>L0200<ESC>S" & FormFGCodeReplaceStoreDet.GVBarcode.GetRowCellValue(j, "code").ToString & vbNewLine
                print_command += "<ESC>H610<ESC>V00" & (add_sato_vpx + 30).ToString & "<ESC>D202100" & FormFGCodeReplaceStoreDet.GVBarcode.GetRowCellValue(j, "code").ToString & vbNewLine
                print_command += "<ESC>H580<ESC>V0" & (add_sato_vpx + 140).ToString & "<ESC>L0200<ESC>S" & FormFGCodeReplaceStoreDet.GVBarcode.GetRowCellValue(j, "name").ToString & vbNewLine
                ...
                print_command += "<ESC>H580<ESC>V0" & (add_sato_vpx + 180).ToString & "<ESC>L0202<ESC>S" & FormFGCodeReplaceStoreDet.GVBarcode.GetRowCellValue(j, "ret_code").ToString & vbNewLine
                print_command += "<ESC>H650<ESC>V0" & (add_sato_vpx + 180).ToString & "<ESC>L0202<ESC>S" & FormFGCodeReplaceStoreDet.GVBarcode.GetRowCellValue(j, "size").ToString & vbNewLine
                print_command += "<ESC>H645<ESC>V0" & (add_sato_vpx + 175).ToString & "<ESC>(65,40" & vbNewLine
                print_command += "<ESC>H740<ESC>V0" & (add_sato_vpx + 180).ToString & "<ESC>L0202<ESC>S" & FormFGCodeReplaceStoreDet.GVBarcode.GetRowCellValue(j, "color").ToString & vbNewLine
                print_command += "<ESC>H580<ESC>V0" & (add_sato_vpx + 220).ToString & "<ESC>L0202<ESC>S" & FormFGCodeReplaceStoreDet.GVBarcode.GetRowCellValue(j, "currency").ToString & " " & Decimal.Parse(FormFGCodeReplaceStoreDet.GVBarcode.GetRowCellValue(j, "price").ToString).ToString("N0") & vbNewLine
                print_command += "<ESC>H580<ESC>V0" & (add_sato_vpx + 260).ToString & "<ESC>L0101<ESC>S" & FormFGCodeReplaceStoreDet.GVBarcode.GetRowCellValue(j, "counting").ToString & vbNewLine
                print_command += "<ESC>H580<ESC>V0" & (add_sato_vpx + 280).ToString & "<ESC>L0202<ESC>BG02070>I" & FormFGCodeReplaceStoreDet.GVBarcode.GetRowCellValue(j, "unique_code").ToString & vbNewLine
                print_command += "<ESC>Q1" & vbNewLine
                print_command += "<ESC>Z" & vbNewLine
                print_command += "" & vbNewLine
            Next
        ...
        ElseIf LEPrinter.EditValue.ToString = "2" Then 'zebra
            For j As Integer = 0 To FormFGCodeReplaceStoreDet.GVBarcode.RowCount - 1
                ...
                print_command += "^FT159," & (add_zebra_vpx + 285).ToString & "^A0N,34,33^FH\^FD" & FormFGCodeReplaceStoreDet.GVBarcode.GetRowCellValue(j, "color").ToString & "^FS" & vbNewLine
                print_command += "^FO86," & (add_zebra_vpx + 252).ToString & "^GB54,42,42^FS" & vbNewLine
                print_command += "^FT86," & (add_zebra_vpx + 285).ToString & "^A0N,34,33^FR^FH\^FD" & FormFGCodeReplaceStoreDet.GVBarcode.GetRowCellValue(j, "size").ToString & "^FS" & vbNewLine
                ...
                print_command += "^LL0406" & vbNewLine
                print_command += "^LS0" & vbNewLine
                print_command += "^FT159," & (add_zebra_vpx + 225).ToString & "^A0N,34,33^FH\^FD" & FormFGCodeReplaceStoreDet.GVBarcode.GetRowCellValue(j, "color").ToString & "  ^FS" & vbNewLine
                print_command += "^FO86," & (add_zebra_vpx + 192).ToString & "^GB54,42,42^FS" & vbNewLine
                print_command += "^FT86," & (add_zebra_vpx + 225).ToString & "^A0N,34,33^FR^FH\^FD" & FormFGCodeReplaceStoreDet.GVBarcode.GetRowCellValue(j, "size").ToString & "^FS" & vbNewLine
                print_command += "^FT3," & (add_zebra_vpx + 268).ToString & "^A0N,34,33^FH\^FD" & FormFGCodeReplaceStoreDet.GVBarcode.GetRowCellValue(j, "currency").ToString & " " & Decimal.Parse(FormFGCodeReplaceStoreDet.GVBarcode.GetRowCellValue(j, "price").ToString).ToString("N0") & "^FS" & vbNewLine
