Public Class ReportOLReturnRefuse
    Public id As String = ""
    Public data As DataTable = New DataTable
    Public id_pre As String = ""
    Public report_mark_type As String = ""

    Private Sub ReportOLReturnRefuse_BeforePrint(sender As Object, e As Printing.PrintEventArgs) Handles MyBase.BeforePrint
        'Detail
        ...
        For i = 0 To data.Rows.Count - 1
            ...
            barcode.Text = data.Rows(i)("scanned_code").ToString
