Public Class ReportProdDemandRevBreakSize
    Public Shared id As String = "-1"
    Public Shared dt As DataTable
    Public Shared dt_size As DataTable
    ...
    Private Sub ReportProdDemandRevBreakSize_BeforePrint(sender As Object, e As Printing.PrintEventArgs) Handles MyBase.BeforePrint
        GCData.DataSource = dt
        GCSize.DataSource = dt_size
        If is_pre = "1" Then
