Public Class ClassPurcAsset
    Public Function queryMain(ByVal condition As String, ByVal order_type As String, ByVal find_accum_value As Boolean) As String
        ...
        a.id_purc_rec_asset_cat,acat.category,
        ...
        INNER JOIN tb_purc_rec_asset_cat acat ON acat.id_purc_rec_asset_cat=a.id_purc_rec_asset_cat
    ...
    Public Function queryAddedValue(ByVal condition As String, ByVal order_type As String, ByVal find_accum_value As Boolean) As String
        If order_type = "1" Then
            order_type = "ASC "
        ElseIf order_type = "2" Then
            order_type = "DESC "
        ...
        Dim query As String = "SELECT po.id_coa_tag AS po_tag,ct.tag_description,a.id_comp_tag,a.id_coa_tag,a.id_purc_rec_asset, a.id_item, a.id_purc_rec_det, r.id_purc_rec, r.purc_rec_number, 
        po.id_purc_order, po.purc_order_number,
        a.id_departement, d.departement, a.id_acc_fa, fa.acc_name AS `acc_fa`,fa.acc_description AS `acc_fa_name`, 
        a.asset_number, a.asset_name, a.asset_note, a.acq_date, 
        a.acq_cost, IFNULL(apc.cost,0) AS `acq_cost_va`, a.is_non_depresiasi, a.useful_life, 
