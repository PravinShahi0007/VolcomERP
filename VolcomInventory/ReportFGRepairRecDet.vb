Public Class ReportFGRepairRecDet
    ...
    Private Sub ReportFGRepairRecDet_BeforePrint(sender As Object, e As Printing.PrintEventArgs) Handles MyBase.BeforePrint
