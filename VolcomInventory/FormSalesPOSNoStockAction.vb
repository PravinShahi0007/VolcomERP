Public Class FormSalesPOSNoStockAction
    ...
    Private Sub SimpleButton2_Click(sender As Object, e As EventArgs) Handles BtnVerify.Click
        Dim qty As String = TEQty.EditValue.ToString
        ...
        Else
            ...
            If confirm = Windows.Forms.DialogResult.Yes Then
                'query upd 
                Dim query_upd As String = "UPDATE tb_sales_pos_no_stock_det nsd SET nsd.is_verified=1, nsd.verified_qty=" + decimalSQL(qty) + ", nsd.verified_note='" + note + "', verified_date=NOW(), verified_by='" + id_user + "' WHERE 1=1 AND (" + where_string + ") "
