Public Class FormSNIBarcode
    ...
    Private Sub GVProdList_DoubleClick(sender As Object, e As EventArgs) Handles GVProdList.DoubleClick
        If GVProdList.RowCount > 0 Then
            If Not GVProdList.IsGroupRow(GVProdList.FocusedRowHandle) Then
                FormBarcodeProductPrint.is_sni = True
                FormBarcodeProductPrint.id_product = GVProdList.GetFocusedRowCellValue("id_product").ToString
