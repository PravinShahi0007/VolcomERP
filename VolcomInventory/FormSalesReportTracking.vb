Public Class FormSalesReportTracking
    ...
    Sub load_data(ByVal id_comp As String, ByVal date_start As String, ByVal date_end As String)
        Dim query As String = "CALL sales_tracking('" & id_comp & "','" & date_start & "','" & date_end & "')"
