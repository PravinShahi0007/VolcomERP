Public Class ClassSalesInv
    ...
    Public Sub cancellUnique(ByVal id_report_param As String, ByVal report_mark_type_param As String)
        ...
        Dim query As String = "INSERT INTO tb_m_unique_code(id_comp, id_product, id_sales_pos_det_counting, id_type, unique_code, id_design_price, design_price, qty, is_unique_report, input_date)  
