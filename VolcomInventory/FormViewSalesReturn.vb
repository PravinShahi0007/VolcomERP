Public Class FormViewSalesReturn 
    ...
    Sub view_problem_summary()
        Dim query As String = "SELECT p.id_product,p.product_full_code AS `code` , d.design_display_name AS `name`, cd.code_detail_name AS `size`,dcd.class, dcd.color, dcd.sht,
