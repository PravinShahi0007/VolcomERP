Public Class ClassPayoutZalora
    Public Function queryMain(ByVal condition As String, ByVal order_type As String) As String
        ...
        z.closing_balance, z.guarantee_deposit, z.total_payout, z.id_acc_default_fee, z.default_comm, z.default_shipping,z.sync_date, z.note, z.is_confirm, IF(z.is_confirm=1,'Confirmed', 'Not Confirmed') AS `is_confirm_view`, z.id_report_status, rs.report_status
