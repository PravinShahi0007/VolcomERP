Public Class ClassOLReturnRefuse
    Public Function queryMain(ByVal condition As String, ByVal order_type As String) As String
        ...
        IFNULL(r.id_sales_return_order,0) AS `id_sales_return_order`, ro.sales_return_order_number,  
        IFNULL(r.id_sales_pos_cn,0) AS `id_sales_pos_cn`, cn.sales_pos_number AS `sales_pos_number_cn`, r.note, r.id_report_status, stt.report_status
        ...
        LEFT JOIN tb_sales_return_order ro ON ro.id_sales_return_order = r.id_sales_return_order
        LEFT JOIN tb_sales_pos cn ON cn.id_sales_pos = r.id_sales_pos_cn
