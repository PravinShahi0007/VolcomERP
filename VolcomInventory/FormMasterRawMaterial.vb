Public Class FormMasterRawMaterial
    ...
    Sub view_refresh_pps()
        Dim q As String = "SELECT pps.`id_mat_det_pps`,pps.`mat_det_code`,mat.`mat_display_name`,pps.`mat_det_display_name`,uom.`uom`,pps.`mat_det_date`,emp.`employee_name`,emp_u.`employee_name` AS emp_update,pps.`mat_det_date`,pps.`last_update_date`
