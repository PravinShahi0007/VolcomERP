Public Class ReportFGRepairReturnRec
    Public Shared id_pre As String = "-1"
    Public Shared id_fg_repair_return_rec As String = "-1"
    Public Shared id_type As String = "-1"
    Public Shared dt As DataTable

    Private Sub ReportFGRepairReturnRec_BeforePrint(sender As Object, e As Printing.PrintEventArgs) Handles MyBase.BeforePrint
