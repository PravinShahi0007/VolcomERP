                            ...
                            If json_diskon("discount_codes").Count > 0 Then
                                ...
                                For Each row_diskon In json_diskon("discount_codes").ToList
                                    If j = 0 Then
                                        ...
                                        VALUES('0', '" + price_rule_id + "', '" + discount_title + "', '" + discount_title + "', '" + value_type + "', '" + value + "', '" + once_per_customer + "', '" + usage_limit + "', '1', NOW(), '" + start_period + "', '" + end_period + "','1','2');SELECT LAST_INSERT_ID(); "
