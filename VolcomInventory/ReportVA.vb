Public Class ReportVA
    Public Shared id As String = "-1"
    Public Shared dt As DataTable
    Public Shared rmt As String = "257"
    Public Shared is_hidden_mark As String = "-1"
    Public Shared id_report_status As String = "-1"

    Private Sub ReportVA_BeforePrint(sender As Object, e As Printing.PrintEventArgs) Handles MyBase.BeforePrint
