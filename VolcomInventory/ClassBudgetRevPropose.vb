Public Class ClassBudgetRevPropose
    Public Function queryMain(ByVal condition As String, ByVal order_type As String) As String
        ...
        Dim query As String = "SELECT rp.id_b_revenue_propose, rp.`number`, rp.year, rp.total, rp.created_date, rp.id_created_user, e.employee_name AS `created_user`, rp.id_report_status, rs.report_status
