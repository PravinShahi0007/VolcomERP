Public Class ClassProductionFinalClear
    Public Function queryMain(ByVal condition As String, ByVal order_type As String) As String
        ...
        Dim query As String = "SELECT f.id_reject_category,IF(f.id_metode_qc=1,'Full QC','AQL') AS metode_qc,f.id_metode_qc,f.id_prod_fc,f.id_service_type, f.id_prod_order, po.prod_order_number, po.id_delivery, sd.delivery, s.id_season,s.season, rg.id_range, rg.`range`,
