...
FROM tb_m_comp WHERE id_comp_cat='6'"
    ...
    Private Sub BSearch_Click(sender As Object, e As EventArgs) Handles BSearch.Click
        ...
        Dim q As String = "(SELECT st.`id_comp`,c.`comp_number`,c.`comp_name`,CONCAT(c.comp_number,' - ',c.comp_name) AS location,i.`id_item`,i.`item_desc`,SUM(st.qty) AS qty,uom.uom
FROM `tb_stock_vm` st
