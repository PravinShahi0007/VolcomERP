                        ...
                        If Not already Then
                            If id_pl_mrs_det <> "0" Then
                                ...
                                If FormMatPLSingle.cond_check Then
                                    ...
                                    FormMatPLSingle.GVDrawer.SetFocusedRowCellValue("pl_mrs_det_qty", qty_input_grid)
                                    ...
                                    FormMatPLSingle.GVDrawer.SetFocusedRowCellValue("qty_all_mat", GVMat.GetFocusedRowCellValue("qty_all_mat"))
