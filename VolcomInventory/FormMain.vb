    ...
    Private Sub BBPrint_ItemClick(ByVal sender As System.Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs) Handles BBPrint.ItemClick
        ...
        ElseIf formName = "FormPurcItemStock" Then
            If FormPurcItemStock.XTCStock.SelectedTabPageIndex = 0 Then
                print(FormPurcItemStock.GCSOH, "Stock On Hand until " & Date.Parse(FormPurcItemStock.DEUntil.EditValue.ToString).ToString("dd MMMM yyyy"))
            ElseIf FormPurcItemStock.XTCStock.SelectedTabPageIndex = 1 Then
                print(FormPurcItemStock.GCSC, "Stock Card " & FormPurcItemStock.SLEITem.Text & Environment.NewLine & " " & Date.Parse(FormPurcItemStock.DEFromSC.EditValue.ToString).ToString("dd/MM/yyyy") & " until " & Date.Parse(FormPurcItemStock.DEUntilSC.EditValue.ToString).ToString("dd/MM/yyyy"))
            End If
        ElseIf formName = "FormEmpUniSumReport" Then
