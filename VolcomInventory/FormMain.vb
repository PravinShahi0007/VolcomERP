...
WHERE pddr.id_prod_demand_design='" & FormProduction.GVDesign.GetFocusedRowCellValue("id_prod_demand_design").ToString & "' AND pdr.id_report_status!='5'"
    ...
    Private Sub NBVirtualSales_LinkClicked(sender As Object, e As DevExpress.XtraNavBar.NavBarLinkEventArgs) Handles NBVirtualSales.LinkClicked
        Cursor = Cursors.WaitCursor
        Try
            FormVirtualSales.MdiParent = Me
    ...
    Private Sub NBDropChanges_LinkClicked(sender As Object, e As DevExpress.XtraNavBar.NavBarLinkEventArgs) Handles NBDropChanges.LinkClicked
        Cursor = Cursors.WaitCursor
        Try
            FormDropChanges.MdiParent = Me
            FormDropChanges.Show()
            FormDropChanges.WindowState = FormWindowState.Maximized
            FormDropChanges.Focus()
        Catch ex As Exception
            errorProcess()
        End Try
        Cursor = Cursors.Default
    ...
    Private Sub NBProductWeight_LinkClicked(sender As Object, e As DevExpress.XtraNavBar.NavBarLinkEventArgs) Handles NBProductWeight.LinkClicked
        Cursor = Cursors.WaitCursor
        Try
            FormReportProductWeight.MdiParent = Me
            FormReportProductWeight.Show()
            FormReportProductWeight.WindowState = FormWindowState.Maximized
            FormReportProductWeight.Focus()
        Catch ex As Exception
            errorProcess()
        End Try
        Cursor = Cursors.Default
