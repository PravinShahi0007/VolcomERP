Public Class FormFGDesignListChanges
    ...
    Sub viewDetail()
        ...
        If is_md = "1" Then
            ...
            IF(det.c_sht=1, sht.sht_name,'-') AS `color`, IF(det.c_sht=1, sht_new.sht_name_new,'-') AS `sht_new`,
            ...
            det.c_source, det.c_division, det.c_subcategory, det.c_class, det.c_color, det.c_sht "
