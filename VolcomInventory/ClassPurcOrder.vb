Public Class ClassPurcOrder
    Public Function queryMain(ByVal condition As String, ByVal order_type As String, is_for_receive As Boolean) As String
        ...
        Dim query As String = "SELECT po.id_coa_tag,po.est_date_receive,po.id_purc_order, c.id_comp,c.comp_number,c.comp_name,cc.contact_person,cc.contact_number,po.purc_order_number,po.date_created,emp_cre.employee_name as emp_created,po.last_update,emp_upd.employee_name AS emp_updated 
