Public Class ReportPromoZalora
    ...
    Private Sub ReportPromoZalora_BeforePrint(sender As Object, e As Printing.PrintEventArgs) Handles MyBase.BeforePrint
        GCItemPropose.DataSource = dt
