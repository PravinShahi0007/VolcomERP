Public Class ReportFGProposePriceAnalysis
    ...
    Private Sub ReportFGProposePriceAnalysis_BeforePrint(sender As Object, e As Printing.PrintEventArgs) Handles MyBase.BeforePrint
        GCAnalysis.DataSource = dt
