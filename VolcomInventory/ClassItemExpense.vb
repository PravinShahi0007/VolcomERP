Public Class ClassItemExpense
    ...
    Public Function queryMain(ByVal condition As String, ByVal order_type As String, ByVal is_for_payment As Boolean) As String
        ...
        ,cf.id_comp AS `id_comp_default`, cf.comp_number as `comp_number_default`,SUM(ed.amount_before*((100-ed.pph_percent)/100)) AS amount_before,ed.kurs,ed.id_currency,cur.currency
        " + col_dp + "
        " + col_pay_pending + "
        " + q_acc + "
